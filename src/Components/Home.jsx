...
export default function Home() {
  ...
  return (
    <Container id="home" maxW={"90%"} mt={"40px"} py={12}>
      <Flex direction={{ base: "column-reverse", lg: "row" }} spacing={10}>
        <Stack
          w={{ base: "100%", lg: '"50%"' }}
          spacing={4}
        ...
        >
          ...
          <Text fontSize={"lg"}>
            ...
            Adaptable to learning new technologies, accountable team player, and
            highly productive. Aims to create world-class web applications while
          ...
          <Stack id="user-detail-intro">
            ...
            >
              ...
              <Flex justifyContent={"space-around"} w="25%">
                ...
                <Link
                  m="5px"
                  href="https://twitter.com/prabhaat4"
                  target="_blank"
                >
                  <svg
                    fill={colorMode === "light" ? "black" : "white"}
